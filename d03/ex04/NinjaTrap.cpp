...
NinjaTrap::NinjaTrap(void) : ClapTrap(60,60,120,120,1,"NINJ4-TP" + ClapTrap::intToString(NinjaTrap::_unassignedNb),60,5,0) {
...
NinjaTrap::NinjaTrap(std::string name) : ClapTrap(60,60,120,120,1,"NI-" + name,60,5,0) {
